interface ConstruktivLogoProps {
  className?: string,
}

export default function ConstruktivLogo({className}: ConstruktivLogoProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="200" height="52.088" fill="#FFFFFF" viewBox="0 0 200 52.088">
      <defs>
      ...
      <g id="cons_Logo" data-name="cons Logo" transform="translate(0 0)">
        <g id="Gruppe_2" data-name="Gruppe 2" transform="translate(0 0)" clipPath="url(#clip-path)">
